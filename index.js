...
❤️❤️❤️Made With Love❤️❤️❤️
Support Me
https://www.instagram.com/hiijee_/
...
contoh : !yt https://youtu.be/ShsFjR1142E

*!ytmp3 url* : Mendownload mp3 dari youtube
contoh : !ytmp3 https://youtu.be/3zEUJ7ryiwI
...
format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles="+ jokowi
axios.get(url)
  .then((result) => {
var d = JSON.parse(JSON.stringify(result.data));
console.log(d.query.normalized[0]);
